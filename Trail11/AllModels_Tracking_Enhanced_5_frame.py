...
def detect_faces_with_tracking(video_path,window_name="default"):
    ...
    #out = cv2.VideoWriter('allModels_tracking_optimized_attention_is_5_frame.mp4', fourcc, fps, (frame_width, frame_height))
    ...
    while True:
        ...
        if frame_count % 5 == 0:
            ...
            for attn_box in attn_results:
                ...
                last_attn_boxes.append(((ax1, ay1, ax2, ay2), attn_class))
        ...
        for x1, y1, x2, y2, conf, centroid in boxes:
            ...
            attention_label = "unattentive"
            t2=perf_counter()
            best_iou = 0
            for (ax1, ay1, ax2, ay2), cls in last_attn_boxes:
        ...
        # cv2.putText(frame, f'FaceDet: {detection_model_time * 1000:.1f}ms', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 200, 200), 2)
        # cv2.putText(frame, f'Recog: {recognition_time * 1000:.1f}ms', (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (200, 255, 200), 2)
        # cv2.putText(frame, f'Attention: {attention_time * 1000:.1f}ms', (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (200, 200, 255), 2)
        # cv2.putText(frame, f'TotalFrame: {elapsed_time * 1000:.1f}ms', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
        #out.write(frame)
        t1 = perf_counter()
        ...
        perf_log.append({
            ...
            "tracking_time_ms": round(total_tracking_time * 1000, 1),
    ...
    with pd.ExcelWriter("allModels&Tracking_Enhanced_attention_5fps_1280.xlsx", engine="openpyxl") as writer:
